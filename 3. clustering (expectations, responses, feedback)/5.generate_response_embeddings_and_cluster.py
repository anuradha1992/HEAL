...
with open('./all_listener_responses.csv', 'r', encoding='utf-8') as infile:
...
import pickle
with open('responses.pkl', 'rb') as handle:
...
for threshold in [0.95, 0.9, 0.85, 0.8, 0.75, 0.7, 0.65, 0.6]:
    ...
    print("Percentage of documents clustered = ", (documents_clustered/245707)*100)
    ...
    file1.write("Percentage of documents clustered = "+str((documents_clustered/245707)*100)+"\n") 
    file1.write("\n\n") 
    file1.close()
