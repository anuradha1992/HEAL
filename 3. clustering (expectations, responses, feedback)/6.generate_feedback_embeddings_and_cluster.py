...
with open('./all_feedback.csv', 'r', encoding='utf-8') as infile:
...
for threshold in [0.95, 0.9, 0.85, 0.8, 0.75, 0.7, 0.65, 0.6]:
    ...
    file1 = open("feedback_stats.txt","a") 
    file1.write("Threshold = "+str(threshold)+"\n")
    file1.write("Clustering done after {:.2f} sec".format(time.time() - start_time))
    file1.write("\n")

    with open("../clusters/feedback/feedback-clustering-"+str(threshold)+".csv", "a+") as f:
    ...
    print("Percentage of documents clustered = ", (documents_clustered/20213)*100)
    ...
    file1.write("Percentage of documents clustered = "+str((documents_clustered/20213)*100)+"\n") 
    file1.write("\n\n") 
    file1.close()
